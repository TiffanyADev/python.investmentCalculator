...
Application that provides an imvenstment report. User provides the details of the investment. Output will be calculations year by year and also some final summaries.
"""
...
rate = float(input("Finally, enter the rate as a % >>"))
